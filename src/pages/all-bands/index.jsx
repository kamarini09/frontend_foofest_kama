     ...
     <section className="flex flex-col justify-between px-10 h-full">
        <div>
          ...
          <h2 className="text-2xl md:text-2xl text-white font-light pb-10 w-full lg:w-1/2">
            Here is the schedule of bands for each day in Midgard, Vanaheim, and Jotunheim.
          </h2>
        </div>
      </section>
      ...
      <section className="container mx-auto p-4 text-center">
        {days.map((day, index) => {
          const midgardActs = schedule.Midgard[day];
          const vanaheimActs = schedule.Vanaheim[day];
          const jotunheimActs = schedule.Jotunheim[day];
          ...
          return (
            <section key={index} className="container mx-auto p-4 text-center">
              <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white py-4">
                {fullDays[index]}
              </h1>
